const languageDictionary = {
  en: {
    ...
    "resume-freelancerole":
      "Aprendice: Graphic design, Illustration, Electronics and Software Development",
    ...
    "opensource-newsletter": `Python lib (PIP) and Slack bot to publish technology news (Filipe Deschamps)`,
    ...
    "music-chordmessage":
      "Contribution or Revision for Cifra Club (Chords Website).",
  ...
  br: {
    ...
    "about-atmega": "ATMega, ESP8266, ESP32",
    "about-electronics":
      "Projetos de Eletrônica,<br>Prototipação, PCB, esquemáticos",
    ...
    "resume-boshrole":
      "Desenvolvedor (Automação Industrial)/ Projetista Eletricista",
    ...
    "resume-freelancerole":
      "Aprendiz: Design Gráfico, Ilustração, Eletrônica e Desenvolvimento de Software",
    ...
    "projects-buenostitle":
      "Sistema de tratamento<br>sanitário de Buenos Aires",
    ...
    "opensource-newsletter": `Biblioteca python (PIP) e Bot de Slack para publicação de notícias de tecnologia (Filipe Deschamps)`,
    ...
    "music-chordsubtitle": "Cifras de violão",
    "music-chordmessage": "Contribuições no site Cifra Club.",
